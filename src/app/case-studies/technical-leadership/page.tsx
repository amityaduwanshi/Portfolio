...
export const metadata: Metadata = {
  title: 'Technical Leadership Case Study | Amit Yaduwanshi',
  description: 'How technical leadership improved code quality, team collaboration, and feature delivery for a technology company.'
};

export default function TechnicalLeadershipCaseStudy() {
  return (
    <div className="min-h-screen pt-20 bg-gray-50 dark:bg-gray-900">
      <Breadcrumbs items={[
        { label: 'Home', href: '/' },
        { label: 'Case Studies', href: '/case-studies' },
        { label: 'Technical Leadership', href: '/case-studies/technical-leadership' }
      ]} />
      <article className="container mx-auto px-4 py-12 max-w-3xl">
        <div className="bg-white/95 dark:bg-gray-800/95 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700 p-8">
          <header className="mb-10">
            <h1 className="text-4xl md:text-5xl font-bold mb-2 text-gray-900 dark:text-white">Technical Leadership</h1>
            <p className="text-lg text-primary-700 dark:text-primary-300 font-semibold mb-4">Technology Company</p>
          </header>
          <section className="mb-8">
            ...
            <p className="text-gray-700 dark:text-gray-300 text-lg">Implemented technical leadership and best practices to address technical debt and improve team productivity.</p>
          </section>
          <section className="mb-8">
            ...
            <ul className="list-disc list-inside space-y-1 text-gray-700 dark:text-gray-300 text-base">
              <li>Technical debt and legacy code</li>
              <li>Low team productivity</li>
              <li>Lack of collaboration and best practices</li>
            </ul>
          </section>
          <section className="mb-8">
            ...
            <p className="text-gray-700 dark:text-gray-300 text-lg">Introduced code reviews, automated testing, and agile methodologies. Fostered a culture of collaboration and continuous improvement.</p>
          </section>
          <section className="mb-8">
            ...
            <ul className="space-y-2">
              <li className="flex items-center text-gray-800 dark:text-gray-100"><span className="mr-2 text-green-500">✓</span>Improved code quality and maintainability</li>
              <li className="flex items-center text-gray-800 dark:text-gray-100"><span className="mr-2 text-green-500">✓</span>Enhanced team collaboration</li>
              <li className="flex items-center text-gray-800 dark:text-gray-100"><span className="mr-2 text-green-500">✓</span>Faster feature development</li>
            </ul>
          </section>
        </div>
